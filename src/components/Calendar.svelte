<!-- <script>
    ...
    selectedDate = day;
    const selectedDateISO = day.toISOString().slice(0, 10);
eventsForSelectedDay = jsonDataByDate.get(selectedDateISO);
...
<script>
  ...
  function handleDayClick(day) {
    selectedDate = day;
    const selectedDateISO = day.toISOString().slice(0, 10);
    eventsForSelectedDay = jsonDataByDate[selectedDateISO] || [];
